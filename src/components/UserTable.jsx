...
const UserTable = () => {
    ...
    return <>
        <div className="flex justify-center">
            <h1 className="text-5xl my-12 text-white">Register Table</h1>
        </div>
        <table className="border-collapse table-auto w-full text-sm">
            <thead>
                <tr>
                    ...
                    <th className="border-b dark:border-slate-600 font-medium p-4 pr-8 pt-0 pb-3 text-slate-400 dark:text-slate-200 text-left">confirm Password</th>
            ...
            <tbody className="bg-white dark:bg-slate-800">
                {
                    $users.map(u => {
                        return u && <tr key={u._id}>
                            ...
                            <td className="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">{u.confirmpassword}</td>
